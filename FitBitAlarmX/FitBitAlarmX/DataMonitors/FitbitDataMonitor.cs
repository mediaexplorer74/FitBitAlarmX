...
namespace DataMonitorLib
{
    public class FitbitDataMonitor : DataMonitor
    {
        ...
        private const string CLIENTID = "xxxxxx";//"238S3D";
        private const string CLIENTSECRET = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";//"078679b0a1f8ad4b5d4aebba989571a7";
        ...
        public FitbitDataMonitor()
        {
            ...
            this.authHelper = new Fitbit.Api.Portable.OAuth2.OAuth2Helper(credentials,
             "https://app-settings.fitbitdevelopercontent.com/simple-redirect.html"   //"http://localhost:4306/aa/data-collection"
            );
            avgs = new ArrayList();
